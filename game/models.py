...
class Question(models.Model):
    ...
    difficulty = models.IntegerField(
        choices=DIFFICULTY_CHOICES, default=1, verbose_name="Difficoltà"
    )
    ...
    option_4 = models.CharField(
        max_length=100, verbose_name="Opzione 4", blank=True, null=True
    )
...
class Score(models.Model):
    ...
    age_group = models.CharField(
        max_length=10,
        choices=Question.AGE_GROUP_CHOICES,
        blank=True,
        null=True,
        verbose_name="Fascia d'età",
    )
...
class HangmanWord(models.Model):
    ...
    hint = models.CharField(
        max_length=100, verbose_name="Indizio", blank=True, null=True
    )
    difficulty = models.IntegerField(
        choices=Question.DIFFICULTY_CHOICES, default=1, verbose_name="Difficoltà"
    )
    age_group = models.CharField(
        max_length=10,
        choices=Question.AGE_GROUP_CHOICES,
